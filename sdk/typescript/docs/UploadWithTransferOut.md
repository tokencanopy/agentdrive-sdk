...
```typescript
import type { UploadWithTransferOut } from '@tokencanopy/agentdrive-sdk'
...
const example = {
  ...
  "cleanup": null,
  "transfer": null,
} satisfies UploadWithTransferOut
...
const exampleParsed = JSON.parse(exampleJSON) as UploadWithTransferOut
