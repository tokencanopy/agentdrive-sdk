...
export class SearchApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for driveSearch without sending the request
     */
    async driveSearchRequestOpts(requestParameters: DriveSearchRequest): Promise<runtime.RequestOpts> {
    ...
    async driveSearchRaw(requestParameters: DriveSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SearchPageOut>> {
        const requestOptions = await this.driveSearchRequestOpts(requestParameters);
