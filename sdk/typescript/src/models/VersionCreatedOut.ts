...
export function instanceOfVersionCreatedOut(value: object): value is VersionCreatedOut {
    ...
    if ((!('artifactRevision' in (value as Record<string, any>)) && !('artifact_revision' in (value as Record<string, any>))) || ((value as Record<string, any>)['artifactRevision'] === undefined && (value as Record<string, any>)['artifact_revision'] === undefined)) return false;
