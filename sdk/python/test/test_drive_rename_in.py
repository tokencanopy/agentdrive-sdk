...
class TestDriveRenameIn(unittest.TestCase):
    """DriveRenameIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DriveRenameIn:
        """Test DriveRenameIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DriveRenameIn`
        """
        model = DriveRenameIn()
        if include_optional:
            return DriveRenameIn(
                name = '0'
            )
        else:
            return DriveRenameIn(
