...
class TestUsagePeriodOut(unittest.TestCase):
    """UsagePeriodOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsagePeriodOut:
        """Test UsagePeriodOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsagePeriodOut`
        """
        model = UsagePeriodOut()
        if include_optional:
