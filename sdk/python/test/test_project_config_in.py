...
class TestProjectConfigIn(unittest.TestCase):
    """ProjectConfigIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectConfigIn:
        """Test ProjectConfigIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectConfigIn`
        """
        model = ProjectConfigIn()
        if include_optional:
            return ProjectConfigIn(
                auto_compile = True,
                engine = '',
                entrypoint = ''
            )
