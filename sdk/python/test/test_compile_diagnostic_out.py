...
class TestCompileDiagnosticOut(unittest.TestCase):
    """CompileDiagnosticOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompileDiagnosticOut:
        """Test CompileDiagnosticOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompileDiagnosticOut`
        """
        model = CompileDiagnosticOut()
        if include_optional:
            return CompileDiagnosticOut(
                category = '',
                file = '',
                line = 56,
                message = '',
    ...
    def testCompileDiagnosticOut(self):
        """Test CompileDiagnosticOut"""
