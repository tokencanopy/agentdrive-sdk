...
class TestInvitationOut(unittest.TestCase):
    """InvitationOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvitationOut:
        """Test InvitationOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvitationOut`
        """
        model = InvitationOut()
        if include_optional:
