...
class TestDescribeIn(unittest.TestCase):
    """DescribeIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeIn:
        """Test DescribeIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeIn`
        """
        model = DescribeIn()
        if include_optional:
            return DescribeIn(
