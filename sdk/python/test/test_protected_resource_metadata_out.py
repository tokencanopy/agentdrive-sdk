...
class TestProtectedResourceMetadataOut(unittest.TestCase):
    """ProtectedResourceMetadataOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectedResourceMetadataOut:
        """Test ProtectedResourceMetadataOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectedResourceMetadataOut`
        """
        model = ProtectedResourceMetadataOut()
        if include_optional:
    ...
    def testProtectedResourceMetadataOut(self):
        """Test ProtectedResourceMetadataOut"""
