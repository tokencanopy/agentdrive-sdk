...
class TestUploadsCreateRequestTargetOneOf(unittest.TestCase):
    """UploadsCreateRequestTargetOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadsCreateRequestTargetOneOf:
        """Test UploadsCreateRequestTargetOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadsCreateRequestTargetOneOf`
        """
        model = UploadsCreateRequestTargetOneOf()
        if include_optional:
            return UploadsCreateRequestTargetOneOf(
                kind = 'artifact',
    ...
    def testUploadsCreateRequestTargetOneOf(self):
        """Test UploadsCreateRequestTargetOneOf"""
