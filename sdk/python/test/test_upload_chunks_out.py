...
class TestUploadChunksOut(unittest.TestCase):
    """UploadChunksOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadChunksOut:
        """Test UploadChunksOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadChunksOut`
        """
        model = UploadChunksOut()
        if include_optional:
            return UploadChunksOut(
                method = 'PUT',
                required_headers = {
                    'key' : ''
                    }
