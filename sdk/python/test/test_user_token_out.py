...
class TestUserTokenOut(unittest.TestCase):
    """UserTokenOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserTokenOut:
        """Test UserTokenOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserTokenOut`
        """
        model = UserTokenOut()
        if include_optional:
            return UserTokenOut(
