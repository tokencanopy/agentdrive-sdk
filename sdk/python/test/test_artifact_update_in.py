...
class TestArtifactUpdateIn(unittest.TestCase):
    """ArtifactUpdateIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtifactUpdateIn:
        """Test ArtifactUpdateIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtifactUpdateIn`
        """
        model = ArtifactUpdateIn()
        if include_optional:
            return ArtifactUpdateIn(
                name = '0',
