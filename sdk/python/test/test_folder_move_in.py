...
class TestFolderMoveIn(unittest.TestCase):
    """FolderMoveIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderMoveIn:
        """Test FolderMoveIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderMoveIn`
        """
        model = FolderMoveIn()
        if include_optional:
            return FolderMoveIn(
