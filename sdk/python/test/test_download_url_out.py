...
class TestDownloadUrlOut(unittest.TestCase):
    """DownloadUrlOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadUrlOut:
        ...
        # uncomment below to create an instance of `DownloadUrlOut`
        """
        model = DownloadUrlOut()
        if include_optional:
