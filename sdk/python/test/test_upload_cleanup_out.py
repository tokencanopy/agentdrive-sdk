...
class TestUploadCleanupOut(unittest.TestCase):
    """UploadCleanupOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadCleanupOut:
        """Test UploadCleanupOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadCleanupOut`
        """
        model = UploadCleanupOut()
        if include_optional:
            return UploadCleanupOut(
                state = 'none'
            )
        else:
            return UploadCleanupOut(
