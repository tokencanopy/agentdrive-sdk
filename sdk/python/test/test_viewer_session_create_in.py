...
class TestViewerSessionCreateIn(unittest.TestCase):
    """ViewerSessionCreateIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewerSessionCreateIn:
        """Test ViewerSessionCreateIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewerSessionCreateIn`
        """
        model = ViewerSessionCreateIn()
        if include_optional:
            return ViewerSessionCreateIn(
    ...
    def testViewerSessionCreateIn(self):
        """Test ViewerSessionCreateIn"""
