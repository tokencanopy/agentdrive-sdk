...
class TestDatasetDescriptionOut(unittest.TestCase):
    """DatasetDescriptionOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatasetDescriptionOut:
        """Test DatasetDescriptionOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetDescriptionOut`
        """
        model = DatasetDescriptionOut()
        if include_optional:
    ...
    def testDatasetDescriptionOut(self):
        """Test DatasetDescriptionOut"""
