...
class TestShareCreateIn(unittest.TestCase):
    """ShareCreateIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareCreateIn:
        """Test ShareCreateIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareCreateIn`
        """
        model = ShareCreateIn()
        if include_optional:
