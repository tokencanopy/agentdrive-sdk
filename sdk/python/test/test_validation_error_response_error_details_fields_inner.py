...
class TestValidationErrorResponseErrorDetailsFieldsInner(unittest.TestCase):
    """ValidationErrorResponseErrorDetailsFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationErrorResponseErrorDetailsFieldsInner:
        """Test ValidationErrorResponseErrorDetailsFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorResponseErrorDetailsFieldsInner`
        """
        model = ValidationErrorResponseErrorDetailsFieldsInner()
        if include_optional:
            return ValidationErrorResponseErrorDetailsFieldsInner(
                location = '',
                reason = ''
            )
        else:
    ...
    def testValidationErrorResponseErrorDetailsFieldsInner(self):
        """Test ValidationErrorResponseErrorDetailsFieldsInner"""
