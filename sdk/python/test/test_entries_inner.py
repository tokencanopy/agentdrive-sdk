...
class TestEntriesInner(unittest.TestCase):
    """EntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntriesInner:
        """Test EntriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntriesInner`
        """
        model = EntriesInner()
        if include_optional:
            return EntriesInner(
