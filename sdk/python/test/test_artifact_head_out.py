...
class TestArtifactHeadOut(unittest.TestCase):
    """ArtifactHeadOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtifactHeadOut:
        """Test ArtifactHeadOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtifactHeadOut`
        """
        model = ArtifactHeadOut()
        if include_optional:
