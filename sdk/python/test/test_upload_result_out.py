...
class TestUploadResultOut(unittest.TestCase):
    """UploadResultOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadResultOut:
        """Test UploadResultOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadResultOut`
        """
        model = UploadResultOut()
        if include_optional:
