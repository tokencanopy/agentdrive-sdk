...
class TestWorkspaceCreateIn(unittest.TestCase):
    """WorkspaceCreateIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCreateIn:
        """Test WorkspaceCreateIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceCreateIn`
        """
        model = WorkspaceCreateIn()
        if include_optional:
            return WorkspaceCreateIn(
                name = '0'
            )
        else:
            return WorkspaceCreateIn(
    ...
    def testWorkspaceCreateIn(self):
        """Test WorkspaceCreateIn"""
