...
class TestUploadsCreateRequestTarget(unittest.TestCase):
    """UploadsCreateRequestTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadsCreateRequestTarget:
        """Test UploadsCreateRequestTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadsCreateRequestTarget`
        """
        model = UploadsCreateRequestTarget()
        if include_optional:
    ...
    def testUploadsCreateRequestTarget(self):
        """Test UploadsCreateRequestTarget"""
