...
class TestClaimMetadata(unittest.TestCase):
    """ClaimMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClaimMetadata:
        """Test ClaimMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClaimMetadata`
        """
        model = ClaimMetadata()
        if include_optional:
