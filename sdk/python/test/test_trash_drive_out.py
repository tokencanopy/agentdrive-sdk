...
class TestTrashDriveOut(unittest.TestCase):
    """TrashDriveOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrashDriveOut:
        """Test TrashDriveOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrashDriveOut`
        """
        model = TrashDriveOut()
        if include_optional:
            return TrashDriveOut(
