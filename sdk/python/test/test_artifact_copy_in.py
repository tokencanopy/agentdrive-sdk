...
class TestArtifactCopyIn(unittest.TestCase):
    """ArtifactCopyIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtifactCopyIn:
        """Test ArtifactCopyIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtifactCopyIn`
        """
        model = ArtifactCopyIn()
        if include_optional:
            return ArtifactCopyIn(
                destination_drive_id = 'drv_bf325375e030fccb',
                destination_parent_id = 'fld_bf325375e030fccb',
                destination_name = '0',
