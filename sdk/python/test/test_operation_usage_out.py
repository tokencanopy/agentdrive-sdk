...
class TestOperationUsageOut(unittest.TestCase):
    """OperationUsageOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationUsageOut:
        """Test OperationUsageOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationUsageOut`
        """
        model = OperationUsageOut()
        if include_optional:
            return OperationUsageOut(
                reads = 56,
                writes = 56
            )
        else:
    ...
    def testOperationUsageOut(self):
        """Test OperationUsageOut"""
