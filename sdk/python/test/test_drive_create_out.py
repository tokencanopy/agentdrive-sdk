...
class TestDriveCreateOut(unittest.TestCase):
    """DriveCreateOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DriveCreateOut:
        """Test DriveCreateOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DriveCreateOut`
        """
        model = DriveCreateOut()
        if include_optional:
