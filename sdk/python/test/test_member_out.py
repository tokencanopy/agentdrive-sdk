...
class TestMemberOut(unittest.TestCase):
    """MemberOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberOut:
        """Test MemberOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemberOut`
        """
        model = MemberOut()
        if include_optional:
            return MemberOut(
