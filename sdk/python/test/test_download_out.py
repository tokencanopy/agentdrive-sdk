...
class TestDownloadOut(unittest.TestCase):
    """DownloadOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadOut:
        """Test DownloadOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownloadOut`
        """
        model = DownloadOut()
        if include_optional:
            return DownloadOut(
