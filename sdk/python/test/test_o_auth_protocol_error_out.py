...
class TestOAuthProtocolErrorOut(unittest.TestCase):
    """OAuthProtocolErrorOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthProtocolErrorOut:
        """Test OAuthProtocolErrorOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthProtocolErrorOut`
        """
        model = OAuthProtocolErrorOut()
        if include_optional:
            return OAuthProtocolErrorOut(
                error = '',
                error_description = ''
            )
        else:
    ...
    def testOAuthProtocolErrorOut(self):
        """Test OAuthProtocolErrorOut"""
