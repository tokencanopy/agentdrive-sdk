...
class TestDriveDeleteOut(unittest.TestCase):
    """DriveDeleteOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DriveDeleteOut:
        """Test DriveDeleteOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DriveDeleteOut`
        """
        model = DriveDeleteOut()
        if include_optional:
