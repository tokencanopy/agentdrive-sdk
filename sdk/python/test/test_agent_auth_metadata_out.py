...
class TestAgentAuthMetadataOut(unittest.TestCase):
    """AgentAuthMetadataOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentAuthMetadataOut:
        """Test AgentAuthMetadataOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentAuthMetadataOut`
        """
        model = AgentAuthMetadataOut()
        if include_optional:
            return AgentAuthMetadataOut(
                claim_endpoint = '',
                events_endpoint = '',
                identity_assertion = { },
                identity_endpoint = '',
    ...
    def testAgentAuthMetadataOut(self):
        """Test AgentAuthMetadataOut"""
