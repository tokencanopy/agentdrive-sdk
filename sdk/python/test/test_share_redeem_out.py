...
class TestShareRedeemOut(unittest.TestCase):
    """ShareRedeemOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareRedeemOut:
        """Test ShareRedeemOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareRedeemOut`
        """
        model = ShareRedeemOut()
        if include_optional:
