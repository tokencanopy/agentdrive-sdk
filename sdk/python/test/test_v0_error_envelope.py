...
class TestV0ErrorEnvelope(unittest.TestCase):
    """V0ErrorEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V0ErrorEnvelope:
        """Test V0ErrorEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0ErrorEnvelope`
        """
        model = V0ErrorEnvelope()
        if include_optional:
            return V0ErrorEnvelope(
                error = { }
            )
        else:
            return V0ErrorEnvelope(
