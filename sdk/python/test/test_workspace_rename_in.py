...
class TestWorkspaceRenameIn(unittest.TestCase):
    """WorkspaceRenameIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceRenameIn:
        """Test WorkspaceRenameIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceRenameIn`
        """
        model = WorkspaceRenameIn()
        if include_optional:
            return WorkspaceRenameIn(
                name = '0'
            )
        else:
            return WorkspaceRenameIn(
    ...
    def testWorkspaceRenameIn(self):
        """Test WorkspaceRenameIn"""
