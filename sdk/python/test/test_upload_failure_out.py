...
class TestUploadFailureOut(unittest.TestCase):
    """UploadFailureOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadFailureOut:
        """Test UploadFailureOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadFailureOut`
        """
        model = UploadFailureOut()
        if include_optional:
            return UploadFailureOut(
                code = ''
            )
        else:
            return UploadFailureOut(
