...
class TestShareErrorOut(unittest.TestCase):
    """ShareErrorOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShareErrorOut:
        """Test ShareErrorOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShareErrorOut`
        """
        model = ShareErrorOut()
        if include_optional:
            return ShareErrorOut(
                error = { }
            )
        else:
            return ShareErrorOut(
