...
class TestGrantPrincipalIn(unittest.TestCase):
    """GrantPrincipalIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantPrincipalIn:
        """Test GrantPrincipalIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantPrincipalIn`
        """
        model = GrantPrincipalIn()
        if include_optional:
            return GrantPrincipalIn(
                email = '',
                id = '',
                type = 'user'
            )
