...
class TestFeedbackCreateOut(unittest.TestCase):
    """FeedbackCreateOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedbackCreateOut:
        """Test FeedbackCreateOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedbackCreateOut`
        """
        model = FeedbackCreateOut()
        if include_optional:
    ...
    def testFeedbackCreateOut(self):
        """Test FeedbackCreateOut"""
