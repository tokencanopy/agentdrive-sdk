...
class TestQueryDryRunOut(unittest.TestCase):
    """QueryDryRunOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryDryRunOut:
        ...
        # uncomment below to create an instance of `QueryDryRunOut`
        """
        model = QueryDryRunOut()
        if include_optional:
            return QueryDryRunOut(
                dry_run = true,
                engine = '',
