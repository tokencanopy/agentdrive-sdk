...
class TestFolderPatchIn(unittest.TestCase):
    """FolderPatchIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderPatchIn:
        """Test FolderPatchIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderPatchIn`
        """
        model = FolderPatchIn()
        if include_optional:
