...
class TestLookupOut(unittest.TestCase):
    """LookupOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LookupOut:
        """Test LookupOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LookupOut`
        """
        model = LookupOut()
        if include_optional:
            return LookupOut(
