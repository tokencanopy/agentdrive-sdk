...
class TestCompileProjectOut(unittest.TestCase):
    """CompileProjectOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompileProjectOut:
        """Test CompileProjectOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompileProjectOut`
        """
        model = CompileProjectOut()
        if include_optional:
    ...
    def testCompileProjectOut(self):
        """Test CompileProjectOut"""
