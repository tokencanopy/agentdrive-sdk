...
class TestQueryResultOut(unittest.TestCase):
    """QueryResultOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryResultOut:
        """Test QueryResultOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryResultOut`
        """
        model = QueryResultOut()
        if include_optional:
