...
class TestValidationErrorBody(unittest.TestCase):
    """ValidationErrorBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationErrorBody:
        """Test ValidationErrorBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorBody`
        """
    ...
    def testValidationErrorBody(self):
        """Test ValidationErrorBody"""
