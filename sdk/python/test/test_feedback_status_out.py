...
class TestFeedbackStatusOut(unittest.TestCase):
    """FeedbackStatusOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedbackStatusOut:
        """Test FeedbackStatusOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedbackStatusOut`
        """
        model = FeedbackStatusOut()
        if include_optional:
    ...
    def testFeedbackStatusOut(self):
        """Test FeedbackStatusOut"""
