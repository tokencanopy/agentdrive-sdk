...
class TestEventOut(unittest.TestCase):
    """EventOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventOut:
        """Test EventOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventOut`
        """
        model = EventOut()
        if include_optional:
            return EventOut(
