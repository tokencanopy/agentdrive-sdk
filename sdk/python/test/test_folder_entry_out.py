...
class TestFolderEntryOut(unittest.TestCase):
    """FolderEntryOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderEntryOut:
        """Test FolderEntryOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderEntryOut`
        """
        model = FolderEntryOut()
        if include_optional:
            return FolderEntryOut(
