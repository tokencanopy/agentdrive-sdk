...
class TestLookupValuesIn(unittest.TestCase):
    """LookupValuesIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LookupValuesIn:
        """Test LookupValuesIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LookupValuesIn`
        """
        model = LookupValuesIn()
        if include_optional:
            return LookupValuesIn(
                column = '',
                dataset = '',
                limit = 56
            )
