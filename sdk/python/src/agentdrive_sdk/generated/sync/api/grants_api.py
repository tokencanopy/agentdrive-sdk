...
class GrantsApi:
    ...
    @validate_call
    def grants_create_with_http_info(
        self,
        drive_id: StrictStr,
        idempotency_key: Optional[StrictStr],
        grant_create_in: GrantCreateIn,
    ...
    @validate_call
    def grants_create_without_preload_content(
        self,
        drive_id: StrictStr,
        idempotency_key: Optional[StrictStr],
        grant_create_in: GrantCreateIn,
    ...
    @validate_call
    def grants_read_with_http_info(
        self,
        drive_id: StrictStr,
        grant_id: StrictStr,
        if_none_match: Optional[StrictStr] = None,
    ...
    @validate_call
    def grants_read_without_preload_content(
        self,
        drive_id: StrictStr,
        grant_id: StrictStr,
        if_none_match: Optional[StrictStr] = None,
    ...
    @validate_call
    def grants_revoke_with_http_info(
        self,
        drive_id: StrictStr,
        grant_id: StrictStr,
        idempotency_key: Optional[StrictStr],
    ...
    @validate_call
    def grants_revoke_without_preload_content(
        self,
        drive_id: StrictStr,
        grant_id: StrictStr,
        idempotency_key: Optional[StrictStr],
    ...
    @validate_call
    def grants_update_with_http_info(
        self,
        drive_id: StrictStr,
        grant_id: StrictStr,
        idempotency_key: Optional[StrictStr],
