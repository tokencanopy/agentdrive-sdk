...
class DrivesList400Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DrivesList400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DrivesList400Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": DrivesList400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
