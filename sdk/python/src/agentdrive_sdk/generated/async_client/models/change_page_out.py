...
class ChangePageOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["has_more", "items", "next_cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ChangeOut.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
