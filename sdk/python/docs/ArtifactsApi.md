...
# **artifacts_content**
> bytearray artifacts_content(drive_id, artifact_id, if_none_match=if_none_match, authorization=authorization)
...
# **artifacts_create**
> ArtifactOut artifacts_create(drive_id, idempotency_key, content, name, parent_id, authorization=authorization, content_type=content_type, metadata=metadata, sha256=sha256)
...
with agentdrive_sdk.ApiClient(configuration) as api_client:
    ...
    drive_id = 'drive_id_example' # str |
    idempotency_key = 'idempotency_key_example' # str |
    content = None # bytearray | The artifact bytes.
    ...
    try:
        # Create Artifact
        api_response = api_instance.artifacts_create(drive_id, idempotency_key, content, name, parent_id, authorization=authorization, content_type=content_type, metadata=metadata, sha256=sha256)
 ...
 **drive_id** | **str**|  |
 **idempotency_key** | **str**|  |
 **content** | **bytearray**| The artifact bytes. |
