...
class McpOauthApi:
    ...
    @validate_call
    def oauth2_register_oauth2_register_post(
        self,
        ...
        _param = self._oauth2_register_oauth2_register_post_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "ClientRegistrationOut",
            '400': "OAuthProtocolErrorOut",
            '429': "ErrorResponse",
        }
    ...
    @validate_call
    def oauth2_register_oauth2_register_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClientRegistrationOut]:
        """Dynamic Client Registration (RFC 7591)
    ...
    @validate_call
    def oauth2_register_oauth2_register_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _oauth2_register_oauth2_register_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def oauth2_revoke_oauth2_revoke_post(
        ...
        _param = self._oauth2_revoke_oauth2_revoke_post_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "object",
            '400': "OAuthProtocolErrorOut",
            '401': "OAuthProtocolErrorOut",
            '403': "OAuthProtocolErrorOut",
            '429': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def oauth2_revoke_oauth2_revoke_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def oauth2_revoke_oauth2_revoke_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _oauth2_revoke_oauth2_revoke_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
