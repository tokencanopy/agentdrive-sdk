...
class SheetOut(BaseModel):
    ...
    """ # noqa: E501
    columns: StrictInt
    has_formulas: StrictBool
    index: StrictInt
    name: StrictStr
    rows: StrictInt
    __properties: ClassVar[List[str]] = ["columns", "has_formulas", "index", "name", "rows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SheetOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SheetOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "has_formulas": obj.get("has_formulas"),
            "index": obj.get("index"),
            "name": obj.get("name"),
            "rows": obj.get("rows")
        })
