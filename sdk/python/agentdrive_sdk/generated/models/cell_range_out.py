...
class CellRangeOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["range", "revision", "sheet", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CellRangeOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CellRangeOut from a dict"""
        if obj is None:
            return None
