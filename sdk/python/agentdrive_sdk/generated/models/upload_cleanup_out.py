...
class UploadCleanupOut(BaseModel):
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['none', 'pending', 'quarantined', 'deleting', 'cleaned', 'blocked']):
            raise ValueError("must be one of enum values ('none', 'pending', 'quarantined', 'deleting', 'cleaned', 'blocked')")
        return value
