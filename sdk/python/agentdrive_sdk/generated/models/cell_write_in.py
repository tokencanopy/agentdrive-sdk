...
class CellWriteIn(BaseModel):
    ...
    CellWriteIn
    """ # noqa: E501
    range: Annotated[str, Field(min_length=1, strict=True)]
    sheet: Annotated[str, Field(min_length=1, strict=True)]
    values: List[List[Any]]
    __properties: ClassVar[List[str]] = ["range", "sheet", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CellWriteIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CellWriteIn from a dict"""
        if obj is None:
            return None
