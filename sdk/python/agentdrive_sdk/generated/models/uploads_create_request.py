...
class UploadsCreateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": UploadsCreateRequestContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "target": UploadsCreateRequestTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
