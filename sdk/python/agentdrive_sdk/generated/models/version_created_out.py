...
class VersionCreatedOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["artifact_id", "artifact_revision", "content_type", "created_at", "created_by", "hash", "id", "origin_message", "origin_session_id", "parent_version_id", "size_bytes", "version_number"]
