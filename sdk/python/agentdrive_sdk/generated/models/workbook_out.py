...
class WorkbookOut(BaseModel):
    ...
    format: StrictStr
    revision: StrictStr
    __properties: ClassVar[List[str]] = ["artifact_id", "cell_count", "editability", "format", "revision"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkbookOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkbookOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "editability": EditabilityOut.from_dict(obj["editability"]) if obj.get("editability") is not None else None,
