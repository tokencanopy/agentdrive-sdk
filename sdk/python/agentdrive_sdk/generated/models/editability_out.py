...
class EditabilityOut(BaseModel):
    """
    Discriminated, not a boolean plus an optional reason — a client branches on `status` and never reasons about a sometimes-absent field.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EditabilityOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EditabilityOut from a dict"""
        if obj is None:
            return None
