...
class DownloadCapabilitiesCreateRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target": DownloadCapabilitiesCreateRequestTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
