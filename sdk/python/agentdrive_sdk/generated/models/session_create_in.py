...
class SessionCreateIn(BaseModel):
    ...
    """ # noqa: E501
    lease_seconds: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["lease_seconds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionCreateIn from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if lease_seconds (nullable) is None
        # and model_fields_set contains the field
        if self.lease_seconds is None and "lease_seconds" in self.model_fields_set:
            _dict['lease_seconds'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionCreateIn from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "lease_seconds": obj.get("lease_seconds")
        })
        return _obj
