...
class DownloadOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["artifact_id", "expires_at", "target", "version_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target": DownloadTargetOut.from_dict(obj["target"]) if obj.get("target") is not None else None,
