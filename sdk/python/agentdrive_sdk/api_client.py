...
from agentdrive_sdk.configuration import Configuration
from agentdrive_sdk.api_response import ApiResponse, T as ApiResponseT
import agentdrive_sdk.models
from agentdrive_sdk import rest
from agentdrive_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(agentdrive_sdk.models, klass)
