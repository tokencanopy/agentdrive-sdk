...
class StorageFootprintOut(BaseModel):
    """
    StorageFootprintOut
    """ # noqa: E501
    as_of: Optional[date] = None
    live_bytes: StrictInt
    total_bytes: StrictInt
    trash_bytes: StrictInt
    version_bytes: StrictInt
    __properties: ClassVar[List[str]] = ["as_of", "live_bytes", "total_bytes", "trash_bytes", "version_bytes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trash_bytes": obj.get("trash_bytes"),
            "version_bytes": obj.get("version_bytes")
        })
        return _obj
