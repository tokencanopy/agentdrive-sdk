...
class CompileJobOut(BaseModel):
    ...
    diagnostics: Optional[List[CompileDiagnosticOut]] = None
    ...
    __properties: ClassVar[List[str]] = ["cache_hit", "diagnostics", "duration_ms", "engine", "job_id", "logs_url", "output", "status", "task"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if logs_url (nullable) is None
        # and model_fields_set contains the field
        if self.logs_url is None and "logs_url" in self.model_fields_set:
            _dict['logs_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diagnostics": [CompileDiagnosticOut.from_dict(_item) for _item in obj["diagnostics"]] if obj.get("diagnostics") is not None else None,
