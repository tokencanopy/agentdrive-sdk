...
class VersionPage(BaseModel):
    ...
    pruned_before: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["items", "next_cursor", "pruned_before"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pruned_before (nullable) is None
        # and model_fields_set contains the field
        if self.pruned_before is None and "pruned_before" in self.model_fields_set:
            _dict['pruned_before'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [VersionOut.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "next_cursor": obj.get("next_cursor"),
            "pruned_before": obj.get("pruned_before")
        })
        return _obj
