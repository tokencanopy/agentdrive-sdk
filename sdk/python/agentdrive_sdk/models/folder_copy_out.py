...
class FolderCopyOut(BaseModel):
    ...
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["created_at", "deleted_at", "description", "drive_id", "etag", "from_fld_id", "id", "inherit_grants", "metageneration", "n_artifacts_copied", "path", "purge_at", "updated_at"]
