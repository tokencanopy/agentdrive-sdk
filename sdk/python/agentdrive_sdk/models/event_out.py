...
class EventOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "actor_name", "art_id", "created_at", "drive_id", "id", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if art_id (nullable) is None
        # and model_fields_set contains the field
        if self.art_id is None and "art_id" in self.model_fields_set:
            _dict['art_id'] = None
