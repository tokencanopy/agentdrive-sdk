...
class ShareMintOut(BaseModel):
    ...
    share_key: StrictStr
    url: StrictStr
    __properties: ClassVar[List[str]] = ["id", "resource_type", "resource_id", "role", "audience", "has_password", "created_at", "expires_at", "last_accessed_at", "access_count", "share_key", "url"]
