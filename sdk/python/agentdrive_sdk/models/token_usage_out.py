...
class TokenUsageOut(BaseModel):
    ...
    """ # noqa: E501
    embed: StrictInt
    llm_cached: StrictInt
    llm_input: StrictInt
    llm_output: StrictInt
    __properties: ClassVar[List[str]] = ["embed", "llm_cached", "llm_input", "llm_output"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "embed": obj.get("embed"),
            "llm_cached": obj.get("llm_cached"),
            "llm_input": obj.get("llm_input"),
