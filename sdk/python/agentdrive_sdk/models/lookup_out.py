...
class LookupOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "parent_id", "revision"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['folder', 'artifact']):
            raise ValueError("must be one of enum values ('folder', 'artifact')")
        return value
