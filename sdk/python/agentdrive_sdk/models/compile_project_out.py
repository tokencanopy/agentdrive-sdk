...
class CompileProjectOut(BaseModel):
    """
    CompileProjectOut
    """ # noqa: E501
    auto_compile: StrictBool
    engine: StrictStr
    entrypoint: StrictStr
    fld_id: StrictStr
    __properties: ClassVar[List[str]] = ["auto_compile", "engine", "entrypoint", "fld_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auto_compile": obj.get("auto_compile"),
            "engine": obj.get("engine"),
            "entrypoint": obj.get("entrypoint"),
            "fld_id": obj.get("fld_id")
        })
        return _obj
