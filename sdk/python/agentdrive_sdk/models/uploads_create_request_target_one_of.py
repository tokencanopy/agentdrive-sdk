...
class UploadsCreateRequestTargetOneOf(BaseModel):
    """
    UploadsCreateRequestTargetOneOf
    """ # noqa: E501
    kind: StrictStr
    parent_folder_id: Annotated[str, Field(strict=True)]
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["kind", "parent_folder_id", "name"]
    ...
    def parent_folder_id_validate_regular_expression(cls, value):
