...
class ClaimMetadata(BaseModel):
    ...
    supported_email_hints: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["claim_endpoint", "supported_email_hints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supported_email_hints": obj.get("supported_email_hints") if obj.get("supported_email_hints") is not None else True
        })
        return _obj
