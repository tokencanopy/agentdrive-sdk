...
class DriveRestoreOut(BaseModel):
    """
    DriveRestoreOut
    """ # noqa: E501
    id: StrictStr
    rebased_artifact_count: StrictInt
    restored_at: datetime
    __properties: ClassVar[List[str]] = ["id", "rebased_artifact_count", "restored_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "rebased_artifact_count": obj.get("rebased_artifact_count"),
