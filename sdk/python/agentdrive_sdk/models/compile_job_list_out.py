...
class CompileJobListOut(BaseModel):
    """
    CompileJobListOut
    """ # noqa: E501
    items: List[CompileJobOut]
    jobs: List[CompileJobOut] = Field(description="Deprecated same-value alias for `items`; retained for compatibility.")
    next_cursor: Optional[StrictStr] = Field(default=None, description="Opaque continuation token, or null when the listing is complete.")
    __properties: ClassVar[List[str]] = ["items", "jobs", "next_cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CompileJobOut.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "jobs": [CompileJobOut.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
