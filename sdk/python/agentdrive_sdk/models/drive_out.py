...
class DriveOut(BaseModel):
    ...
    state: StrictStr
    __properties: ClassVar[List[str]] = ["id", "workspace_id", "created_by", "name", "metadata", "revision", "root_folder_id", "storage_bytes", "retrieval_bytes", "created_at", "updated_at", "deleted_at", "state"]
