...
class ClaimInitRequest(BaseModel):
    ...
    """ # noqa: E501
    claim_token: StrictStr = Field(description="The per-identity claim_token returned by POST /agent/identity.")
    email: Optional[StrictStr] = Field(default=None, description="Optional hint to display on the /claim page so the human knows which account the agent expected. Not enforced (design §14 question #3).")
    __properties: ClassVar[List[str]] = ["claim_token", "email"]
