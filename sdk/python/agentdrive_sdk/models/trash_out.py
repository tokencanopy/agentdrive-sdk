...
class TrashOut(BaseModel):
    ...
    """ # noqa: E501
    artifacts: List[TrashArtifactOut] = Field(description="Deprecated alias of items.")
    drive: TrashDriveOut
    items: List[TrashArtifactOut]
    next_cursor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["artifacts", "drive", "items", "next_cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifacts": [TrashArtifactOut.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None,
            "drive": TrashDriveOut.from_dict(obj["drive"]) if obj.get("drive") is not None else None,
            "items": [TrashArtifactOut.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
