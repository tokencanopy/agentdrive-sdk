...
class ProtectedResourceMetadataOut(BaseModel):
    ...
    """ # noqa: E501
    authorization_servers: List[StrictStr]
    bearer_methods_supported: List[StrictStr]
    resource: StrictStr
    scopes_supported: List[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["authorization_servers", "bearer_methods_supported", "resource", "scopes_supported"]
