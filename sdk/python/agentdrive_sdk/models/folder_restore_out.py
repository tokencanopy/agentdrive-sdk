...
class FolderRestoreOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "drive_id", "path", "description", "inherit_grants", "metageneration", "etag", "created_at", "updated_at", "deleted_at", "purge_at", "n_subfolders_restored", "n_artifacts_restored"]
