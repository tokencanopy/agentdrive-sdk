...
class GrantOut(BaseModel):
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "drive_id", "resource_type", "resource_id", "principal_type", "principal_id", "role", "revision", "state", "expires_at", "revoked_at", "created_at"]
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['active', 'revoked', 'expired']):
            raise ValueError("must be one of enum values ('active', 'revoked', 'expired')")
        return value
