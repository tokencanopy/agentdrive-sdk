...
class GrantOut(BaseModel):
    ...
    role: StrictStr
    __properties: ClassVar[List[str]] = ["artifacts_affected", "created_at", "expires_at", "granted_by_id", "granted_by_type", "id", "on_behalf_of", "principal_email", "principal_id", "principal_type", "resource_id", "resource_type", "role"]
