...
class DatasetDescriptionOut(BaseModel):
    """
    DatasetDescriptionOut
    """ # noqa: E501
    columns: List[QueryColumnOut]
    dataset: StrictStr
    __properties: ClassVar[List[str]] = ["columns", "dataset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [QueryColumnOut.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
