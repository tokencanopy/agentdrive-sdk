...
class CompileJobIn(BaseModel):
    """
    CompileJobIn
    """ # noqa: E501
    options: Optional[CompileOptions] = None
    task: Optional[StrictStr] = 'latex.compile'
    __properties: ClassVar[List[str]] = ["options", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": CompileOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "task": obj.get("task") if obj.get("task") is not None else 'latex.compile'
        })
        return _obj
