...
class VersionRetentionOut(BaseModel):
    """
    VersionRetentionOut
    """ # noqa: E501
    versions_max: StrictInt
    __properties: ClassVar[List[str]] = ["versions_max"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionRetentionOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionRetentionOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "versions_max": obj.get("versions_max")
        })
        return _obj
