...
func (r ApiInviteMemberV0MembersInvitePostRequest) Authorization(authorization string) ApiInviteMemberV0MembersInvitePostRequest {
...
func (r ApiRevokeInvitationV0InvitationsInvitationIdDeleteRequest) Authorization(authorization string) ApiRevokeInvitationV0InvitationsInvitationIdDeleteRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiSetMemberRoleV0MembersTargetUserIdPatchRequest) Authorization(authorization string) ApiSetMemberRoleV0MembersTargetUserIdPatchRequest {
	r.authorization = &authorization
	return r
}
