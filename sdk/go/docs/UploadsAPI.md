...
func main() {
	driveId := "driveId_example" // string | 
	idempotencyKey := "idempotencyKey_example" // string | 
	uploadsCreateRequest := *openapiclient.NewUploadsCreateRequest(openapiclient.uploads_create_request_target{UploadsCreateRequestTargetOneOf: openapiclient.NewUploadsCreateRequestTargetOneOf("Kind_example", "ParentFolderId_example", "Name_example")}, *openapiclient.NewUploadsCreateRequestContent(int32(123), "MediaType_example", *openapiclient.NewUploadsCreateRequestContentChecksum("Algorithm_example", "Value_example"))) // UploadsCreateRequest | 
